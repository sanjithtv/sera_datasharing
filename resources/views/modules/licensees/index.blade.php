                    ...
                    <div class="row g-2">
                        ...
                        <div class="col-md-auto ms-auto">
                            <div class="d-flex align-items-center gap-2">
                                <a href="{{ route('licensees.create') }}" class="btn btn-info add-btn" ><i
                                    class="ri-add-fill me-1 align-bottom"></i> @lang('translation.new_licensee')</a>
                                        ...
                                        <td>
                                            <ul class="list-inline hstack gap-2 mb-0">
                                                ...
                                                <li class="list-inline-item" data-bs-toggle="tooltip"
                                                    ...
                                                    <form action="{{ route('licensees.archive', $licensee->id) }}" method="POST" class="d-inline"
