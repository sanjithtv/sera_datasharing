            ...
            <div class="card" id="companyList">
                ...
                <div class="card-body">
                    <div class="live-preview">
                        ...
                        <form action="{{ route('assessments.upload') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="row gy-4">
                        ...
                        <button type="submit" formaction="{{ route('assessments.upload') }}" class="btn btn-primary">Upload Excel</button>
                        <button type="submit" formaction="{{ route('assessments.store') }}" class="btn btn-secondary">Manual Entry</button>
                        </form>
