                            ...
                            <table class="table align-middle table-nowrap mb-0" id="customerTable">
                                ...
                                <tbody class="list form-check-all">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('forms.licensee_templates.edit', $assessment->id) }}" class="edit-item-btn"><i
                                                                                class="ri-pencil-fill align-bottom text-muted"></i></a>
                                            <form action="{{ route('forms.licensee_templates.destroy', $assessment->id) }}" method="POST" style="display:inline">
                                                @csrf @method('DELETE')
