            ...
            <div class="card">
                <div class="card-body text-center">
                    ...
                    <div class="hstack gap-2 justify-content-center">
                        <button class="btn btn-info btn-sm"><i class="ri-stop-circle-line align-bottom me-1"></i>
                            Stop</button>
                        <button class="btn btn-primary btn-sm"><i class="ri-play-circle-line align-bottom me-1"></i>
                            Start</button>
                    </div>
                </div>
            </div>
                        ...
                        <li>
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 ms-2">
                                    <h6 class="mb-1"><a href="pages-profile"
                                            class="text-body">Tonya
                                            Noble</a></h6>
                        ...
                        <div class="border rounded border-dashed p-2">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="flex-grow-1 overflow-hidden">
                                    <h5 class="fs-14 mb-1"><a href="javascript:void(0);"
                    ...
                    <div class="text-muted">
                        ...
                        <div class="pt-3 border-top border-top-dashed mt-4">
                            ...
                            <div class="hstack flex-wrap gap-2 fs-15">
                                <div class="badge fw-semibold bg-info-subtle text-info">UI/UX</div>
                                <div class="badge fw-semibold bg-info-subtle text-info">Dashboard</div>
                                <div class="badge fw-semibold bg-info-subtle text-info">Design</div>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card-header">
                    <div>
                        <ul class="nav nav-tabs-custom rounded card-header-tabs border-bottom-0" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link fw-semibold active" data-bs-toggle="tab" href="#home-1" role="tab">
                                    Comments (5)
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fw-semibold" data-bs-toggle="tab" href="#messages-1" role="tab">
                                    Attachments File (4)
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link fw-semibold" data-bs-toggle="tab" href="#profile-1" role="tab">
                            ...
                            <div data-simplebar style="height: 508px;" class="px-3 mx-n3 mb-2">
                                <div class="d-flex mb-4">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        <h5 class="fs-14"><a href="pages-profile"
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">If you have further questions, please contact Customer
                                            Support from the “Action Menu” on your <a href="javascript:void(0);"
                                                class="text-decoration-underline link-info">Online Order Support</a>.</p>
                                        <a href="javascript: void(0);" class="badge text-muted bg-light"><i
                                                class="mdi mdi-reply"></i> Reply</a>
                                    </div>
                                </div>
                                <div class="d-flex">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <p class="text-muted">Your <a href="javascript:void(0)"
                                                class="text-decoration-underline link-info">Online Order Support</a>
                                            provides you with the most current status of your order. To help manage your
                                            order refer to the “Action Menu” to initiate return, contact Customer Support
                                            and more.</p>
                            ...
                            <form class="mt-4">
                                <div class="row g-3">
                                    ...
                                    <div class="col-12 text-end">
                                        <button type="button" class="btn btn-ghost-info btn-icon waves-effect me-1"><i
                                        ...
                                        <tr>
                                            <td>
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div class="flex-grow-1 ms-2">
                                                        <a href="pages-profile"
                                                            class="fw-medium text-body">Tonya Noble</a>
                                                    </div>
                                                </div>
                                            </td>
                                            <td>28 Dec, 2021</td>
