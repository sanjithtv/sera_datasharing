        ...
        <div class="col-xxl-8">
            <div class="card card-height-100">
                ...
                <div class="card-body p-0 pb-2">
                    <div class="w-100">
                        <div id="line_chart_dashed" data-colors='["--vz-secondary", "--vz-info", "--vz-primary"]'
                ...
                <div class="row g-0">
                    ...
                    <div class="col-lg-6">
                        <div class="card-body text-center">
                            ...
                            <div>
                                <button type="button" class="btn btn-info custom-toggle w-100" data-bs-toggle="button"
                                    aria-pressed="false">
                    ...
                    <div class="table-responsive table-card">
                        <table class="table table-borderless table-centered align-middle table-nowrap mb-0">
                            ...
                            <tbody>
                                <tr>
                                    <td>
                                        <a href="#!" class="fw-medium text-body">#VZ2112</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                    ...
                                    <td>
                                        <h5 class="fs-14 fw-medium mb-0">5.0<span class="text-muted fs-12 ms-1">(245
                                                Rating)</span></h5>
                                    </td>
                                </tr><!-- end tr -->
                                <tr>
                                    <td>
                                        <a href="#!" class="fw-medium text-body">#VZ2111</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                    ...
                                    <td>
                                        <h5 class="fs-14 fw-medium mb-0">4.5<span class="text-muted fs-12 ms-1">(645
                                                Rating)</span></h5>
                                    </td>
                                </tr><!-- end tr -->
                                <tr>
                                    <td>
                                        <a href="#!" class="fw-medium text-body">#VZ2109</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <a href="#!" class="fw-medium text-body">#VZ2108</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
                                ...
                                <tr>
                                    <td>
                                        <a href="#!" class="fw-medium text-body">#VZ2110</a>
                                    </td>
                                    <td>
                                        <div class="d-flex align-items-center">
                                            <div class="flex-shrink-0 me-2">
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body">
                    ...
                    <div class="px-2 py-2 mt-4">
                        <p class="fs-15 mb-1">Canada <span class="float-end">75%</span></p>
                        ...
                        <p class="fs-15 mt-3 mb-1">Greenland <span class="float-end">47%</span>
                        </p>
                        <div class="progress mt-2" style="height: 6px;">
                            <div class="progress-bar progress-bar-striped bg-secondary" role="progressbar"
                        ...
                        <p class="fs-15 mt-3 mb-1">Russia <span class="float-end">82%</span></p>
                        <div class="progress mt-2" style="height: 6px;">
                            <div class="progress-bar progress-bar-striped bg-secondary" role="progressbar"
