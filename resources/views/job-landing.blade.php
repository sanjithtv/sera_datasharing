            ...
            <div class="container-fluid custom-container">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav mx-auto mt-2 mt-lg-0" id="navbar-example">
                        ...
                        <li class="nav-item">
                            <a class="nav-link fw-normal" href="#process">Process</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-normal" href="#categories">Categories</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-normal" href="#findJob">Find Jobs</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-normal" href="#candidates">Candidates</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link fw-normal" href="#blog">Blog</a>
                        </li>
                    </ul>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted fs-16">A creative person has the ability to invent and develop original ideas, especially in the arts. Like so many creative people, he was never satisfied.</p>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted fs-16">Post a job to tell us about your project. We'll quickly match you with the right freelancers.</p>
                        </div>
                    </div>
                    <!-- end col -->
                </div>
                ...
                <div class="row align-items-center gy-4">
                    <div class="col-sm">
                        <div>
                            ...
                            <p class="text-white-50 fs-16 mb-0">Create new account and refer your friend</p>
                        </div>
                    </div>
                    <!-- end col -->
                ...
                <div class="row align-items-center gy-4">
                    <div class="col-lg-6 order-2 order-lg-1">
                        <div class="text-muted mt-5 mt-lg-0">
                            ...
                            <p class="ff-secondary mb-2 fs-16">The demand for content writing services is growing. This is because content is required in almost every industry. <b>Many companies have discovered how effective content marketing is.</b> This is a major reason for this increase in demand.</p>
                            <p class="mb-4 ff-secondary fs-16">A Content Writer is a professional who writes informative and engaging articles to help brands showcase their products.</p>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-8">
                        <div class="text-center mb-5">
                            ...
                            <p class="text-muted fs-16 mb-4">We thrive when coming up with innovative ideas but also understand that a smart concept should be supported with faucibus sapien odio measurable results.</p>
                        </div>
                    </div>
                </div>
                <!-- end row -->
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted fs-15">One disadvantage of Lorum Ipsum is that in Latin certain letters appear more frequently than others.</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted fs-15">Due to its widespread use as filler text for layouts, non-readability is of great importance: human perception.</p>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p class="text-muted fs-15">Intrinsically incubate intuitive opportunities and real-time potentialities Appropriately communicate one-to-one technology.</p>
                ...
                <div class="row align-items-center gy-4">
                    <div class="col-sm">
                        <div>
                            ...
                            <p class="text-white text-opacity-75 fs-16 mb-0">Subscribe & get all related jobs notification.</p>
                        </div>
                    </div>
                    <!-- end col -->
                    <div class="col-sm-auto">
