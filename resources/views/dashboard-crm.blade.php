    ...
    <div class="row">
        ...
        <div class="col-xxl-3 col-md-6">
            <div class="card card-height-100">
                ...
                <div class="card-body pb-0">
                    <div id="deal-type-charts" data-colors='["--vz-warning", "--vz-info", "--vz-primary"]'
                        class="apex-charts" dir="ltr"></div>
                </div><!-- end card body -->
            </div><!-- end card -->
        </div><!-- end col -->
        ...
        <div class="col-xxl-6">
            <div class="card card-height-100">
                ...
                <div class="card-body px-0">
                    ...
                    <div id="revenue-expenses-charts" data-colors='["--vz-info", "--vz-primary"]' class="apex-charts"
                        dir="ltr"></div>
                </div>
            </div><!-- end card -->
        </div><!-- end col -->
                        ...
                        <table class="table table-borderless table-hover table-nowrap align-middle mb-0">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td><span class="badge bg-primary-subtle text-primary p-2">Deal Won</span></td>
                                    <td>
            ...
            <div class="card card-height-100">
                ...
                <div class="card-body p-0">
                    ...
                    <div class="align-items-center p-3 justify-content-between d-flex">
                        ...
                        <button type="button" class="btn btn-sm btn-info"><i class="ri-add-line align-middle me-1"></i>
                            Add Task</button>
                    </div><!-- end card header -->
